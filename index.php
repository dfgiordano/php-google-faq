<?php 
    $arrayFAQ = [
        ...
        [
            "second_question" => " <h2> Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro? </h2>  ",
            "second_answer" => " <p> Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno. </p> ".
        ...
        [
            "third_question" => " <h2> Perché il mio account è associato a un paese? </h2>  ",
            "third_answer" => "<p> Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose: 
            <ol>
...
<html lang="en">
    ...
    <body>
        <header>
            <a href="#">
                <img class="google" src="https://www.udine20.it/wp-content/uploads/2020/12/google.jpg" alt="google_img">
            </a>
            
        </header>
        <?php 
            foreach ($arrayFAQ as $key => $singleFAQ) {
        ?>
                <!-- echo("<h2>".$singleFAQ["first_question"]."</h2>");
                echo($singleFAQ["first_answer"]);
                echo("<h2>".$singleFAQ["second_question"]."</h2>");
                echo($singleFAQ["second_answer"]);
                echo("<h2>".$singleFAQ["third_question"]."</h2>");
                echo($singleFAQ["third_answer"]);
                echo("<h2>".$singleFAQ["fourth_question"]."</h2>");
                echo($singleFAQ["fourth_answer"]);
                echo("<h2>".$singleFAQ["fifth_question"]."</h2>");
                echo($singleFAQ["fifth_answer"]); -->
                <div class="container">
                    <div class="row">
                        <h2><?php echo $singleFAQ["first_question"]; ?>
                        </h2>
                        <p><?php echo $singleFAQ["first_answer"]; ?>
                        </p>
                        <h2><?php echo $singleFAQ["second_question"]; ?>
                        </h2>
                        <p><?php echo $singleFAQ["second_answer"]; ?>
                        </p>
                        <h2><?php echo $singleFAQ["third_question"]; ?>
                        </h2>
                        <p><?php echo $singleFAQ["third_answer"]; ?>
                        </p>
                        <h2><?php echo $singleFAQ["fourth_question"]; ?>
                        </h2>
                        <p><?php echo $singleFAQ["fourth_answer"]; ?>
                        </p>
                        <h2><?php echo $singleFAQ["fifth_question"]; ?>
                        </h2>
                        <p><?php echo $singleFAQ["fifth_answer"]; ?>
                        </p>
                    </div>
                </div>
